...
public class WisataEdukasi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] values = new String[]{"Museum Geologi","Gedung Sate","Lembang Park Zoo","Saung Udjo"
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position == 1) {
                    Intent myIntent = new Intent(view.getContext(), GedungSate.class);
                    startActivityForResult(myIntent, 0);
                }

                if (position == 1) {
                    Intent myIntent = new Intent(view.getContext(), SaungUdjo.class);
                    startActivityForResult(myIntent, 0);
                }
