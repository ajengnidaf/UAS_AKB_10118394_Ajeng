...
public class WisataKuliner extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] values = new String[]{"Tutug Oncom", "Mie Kocok"
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position == 0) {
                    Intent myIntent = new Intent(view.getContext(), MieKocok.class);
                    startActivityForResult(myIntent, 0);
                }

                if (position == 1) {
                    Intent myIntent = new Intent(view.getContext(), TutugOncom.class);
                    startActivityForResult(myIntent, 0);
                }
